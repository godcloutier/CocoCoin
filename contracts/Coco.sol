...
/*
    ...
    5% of every transacion is converted to BNB and sent to the  Lupus Foundation of America (@LupusOrg on twitter) BSC wallet 
    

    
    5% of every transaction is redistributed between holders of the coin
    5% if every transacion is burned
    

    Twitter: https://twitter.com/cocochaneladair
...
contract Coco is Context, IERC20, Ownable {
    ...
    address payable public charityAddress = 0x8B71ac4EB7B746179C2f9Dc572fb669c36dd937C; // Charity Address
